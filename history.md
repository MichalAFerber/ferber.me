...
<img src="/assets/images/image02.jpg" alt="Ferber Family Crest" class="flag-image">

## Early Origins of the Ferber Family
  
The surname Ferber was first found in <strong>Austria</strong>, where the name Farber became noted for its many branches in the region, each house acquiring a status and influence which was envied by the princes of the region.
...
<iframe src="https://mozilla.github.io/pdf.js/web/viewer.html?file=https://michalferber.me/assets/docs/Ferber_Germany_History.pdf" width="100%" height="600" style="border: 1px solid var(--landing-border); border-radius: 4px;" allowfullscreen></iframe>